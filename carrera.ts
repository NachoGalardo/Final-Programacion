...
export class Carrera extends Maquina implements Comportamiento{
    ...
    public resultadoJuego(numeroCaballoApostado:number, valorApuesta:number) : number {
        ...
        if (numeroCaballoApostado == podio[0].getNumeroCaballo()) {
            ...
            console.log (`Cruzaron el disco. El caballo ganador es ${podio[0].getNombre()} con el numero ${podio[0].getNumeroCaballo()} !!`);
